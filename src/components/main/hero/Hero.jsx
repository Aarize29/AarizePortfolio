...
const Hero = () => {
  return (
    <div className='p-10  bg-backimage bg-repeat-space h-full '>
       <div className="">
       <h1 className="text-4xl font-bold m-3 text-[fuchsia]">
       Peace Be Upon You,
       </h1>
       ...
       <Link to='/about'><div className="flex justify-end items-end text-[fuchsia] mr-5 text-xl underline cursor-pointer"><h1 className=' hover:text-white'>Know more about me...</h1></div></Link>
