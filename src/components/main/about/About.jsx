...
<h1>Hello, my name is <span className='text-[fuchsia] text-2xl font-semibold'>Shams Aarize  Siddique</span> . I am a full stack web developer with expertise in ReactJS, Tailwind CSS, React-Redux, Firebase, Node-ExpressJS, and MongoDB. I am currently learning NextJS and exploring the exciting field of Artificial Intelligence and Machine Learning. <Link to='/skills'><span className='text-[fuchsia] text-2xl font-semibold cursor-pointer hover:underline decoration-white'> My skills</span></Link> include machine learning concepts like Pandas, NumPy, Seaborn, Matplotlib, and various machine learning algorithms. Apart from web development, I am also proficient in Java and C. With a passion for coding and a constant thirst for knowledge, I strive to keep myself updated with the latest advancements in technology. I believe in delivering quality work and building lasting relationships with clients.</h1> <span className='font-bold text-[fuchsia]'>Let's connect and discuss how we can bring your ideas to life!</span></div>
